...
landmine_detonate = Button(pygame.Rect(10, 115, 380, 50), "Landmine detonate", f"{current_folder}landmine_sounds\detonate.mp3")
landmine_detonatedistance = Button(pygame.Rect(10, 175, 380, 50), "Landmine detonate distance", f"{current_folder}landmine_sounds\detonatedistance.mp3")
landmine_press = Button(pygame.Rect(10, 235, 380, 50), "Landmine press", f"{current_folder}landmine_sounds\press.mp3")
landmine_trigger = Button(pygame.Rect(10, 295, 380, 50), "Landmine trigger", f"{current_folder}landmine_sounds\\trigger.mp3")
# Bracken
bracken_angered = Button(pygame.Rect(10, 55, 380, 50), "Bracken angered", f"{current_folder}bracken_sounds\\angered.mp3")
bracken_crackneck = Button(pygame.Rect(10, 115, 380, 50), "Bracken crackneck", f"{current_folder}bracken_sounds\crackneck.mp3")
bracken_stun = Button(pygame.Rect(10, 175, 380, 50), "Bracken stun", f"{current_folder}bracken_sounds\stun.mp3")
# Forest keeper
...
forestkeeper_stomp = Button(pygame.Rect(10, 115, 380, 50), "Forest keeper stomp", f"{current_folder}forestkeeper_sounds\stomp.mp3")
forestkeeper_stun = Button(pygame.Rect(10, 175, 380, 50), "Forest keeper stun", f"{current_folder}forestkeeper_sounds\stun.mp3")
# Loot bug
...
lootbug_angryscreech2 = Button(pygame.Rect(10, 115, 380, 50), "Loot bug angry screech 2", f"{current_folder}lootbug_sounds\\angryscreech2.mp3")
lootbug_cry = Button(pygame.Rect(10, 175, 380, 50), "Loot bug cry", f"{current_folder}lootbug_sounds\cry.mp3")
